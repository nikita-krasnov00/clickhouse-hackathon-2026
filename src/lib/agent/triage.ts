 ...
 *
 * language — the language of the questions ("English"/"Russian"/"Greek"), from
 * the UI locale: presets are visible before the user's first question, so the
 * interface sets the language.
 */
